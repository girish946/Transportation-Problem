...
public class TransportationProblem {
    ...
    public String getFeasibleSolutionString()
    {
        return this.feasibleString.toString();
    }
    ...
    public double getSolution(){
        ...
        for(Variable x: feasible){
            ...
            feasibleString.append( x.getValue()+ " * "+ cost[x.getStock()][x.getRequired()]+ " \n+");
        }
        feasibleString.deleteCharAt(feasibleString.length()-1);
